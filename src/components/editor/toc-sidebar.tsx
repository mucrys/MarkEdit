...
export function TocSidebar({ content, isOpen, onClose, onSelect }: TocSidebarProps) {
  ...
  return (
    <div className={cn(
      "fixed md:relative top-0 right-0 h-full bg-white border-l shadow-2xl md:shadow-none transition-all duration-300 z-50 overflow-hidden flex flex-col",
